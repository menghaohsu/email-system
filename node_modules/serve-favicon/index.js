...
function favicon(path, options) {
  ...
  if (!path) throw new TypeError('path to favicon.png is required');
  ...
  if (Buffer.isBuffer(path)) {
    ...
    throw new TypeError('path to favicon.png must be string or buffer');
  }

  return function favicon(req, res, next){
    if (parseUrl(req).pathname !== '/favicon.png') {
      next();
      return;
    }
