...
Why use this module?
  ...
  - User agents request `favicon.png` frequently and indiscriminately, so you
...
which is `GET /favicon.png`. For additional vendor-specific icons that require
...
var _favicon = favicon(__dirname + '/public/favicon.png');
